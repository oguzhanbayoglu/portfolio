      ...
      {projects.projects.map((prj, i) => (
        ...
        >
          <NavLink activeClass="active" to={prj.to} className="w-full h-full">
            ...
            <div className="absolute group-hover:top-[calc(20%)] top-24 md:top-40 lg:top-[12rem] 2xl:top-[8rem] 2xl:left-[6rem] left-16 md:left-32 h-full w-full rounded-3xl backdrop-blur-[50rem] backdrop-saturate-[2] bg-black/70 saturate-150">
